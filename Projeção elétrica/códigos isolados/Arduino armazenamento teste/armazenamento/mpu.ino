void acelerometro() {
  if((millis() - mpu_millisInicial) > 250){
    ...
    */
    ...
    //Serial.print(AccX1*9.8 / 4096);
    //Serial.print(" ");
    //Serial.print(AccY1*9.8 / 4096);
    //Serial.print(" ");
    //Serial.println(AccZ1*9.8 / 4096);

    //Serial.print(AccX2*9.8 / 4096);
    //Serial.print(" ");
    //Serial.print(AccY2*9.8 / 4096);
    //Serial.print(" ");
    //Serial.println(AccZ2*9.8 / 4096);
    
    //Serial.println("===================================");

    //Serial.print(GyrX1 / 131);
    //Serial.print(" ");
    //Serial.print(GyrY1 / 131);
    //Serial.print(" ");
    //Serial.println(GyrZ1 / 131);

    //Serial.print(GyrX2 / 131);
    //Serial.print(" ");
    //Serial.print(GyrY2 / 131);
    //Serial.print(" ");
    //Serial.println(GyrZ2 / 131);
