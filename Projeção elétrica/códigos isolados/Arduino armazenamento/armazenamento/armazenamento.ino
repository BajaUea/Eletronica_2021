...
void loop()
{
  ...
  if((millis() - tempo) > 1000){
    ...
    if (dataFile) {
      ...
      Serial.print(AccX1/8192);
      Serial.print(",");
      Serial.print(AccY1/8192);
      Serial.print(",");
      Serial.print(AccZ1/8192);
      Serial.print(",");
      ...
      Serial.print(",");
      Serial.print(GyrZ1/131);
      Serial.print(",");
      
      Serial.print(AccX2/8192);
      Serial.print(",");
      Serial.print(AccY2/8192);
      Serial.print(",");
      Serial.print(AccZ2/8192);
      Serial.print(",");
