...
float AccX1, AccY1, AccZ1, Temp1, GyrX1, GyrY1, GyrZ1;//Variaveis de Aceleração, Tempo e Giroscopio MPU1
float AccX2, AccY2, AccZ2, Temp2, GyrX2, GyrY2, GyrZ2;//Variaveis de Aceleração, Tempo e Giroscopio MPU2

UltraSonicDistanceSensor distanceSensor(8, 7); //Echo pino 7 Trig pino 8
UltraSonicDistanceSensor distanceSensor2(10, 9); //Echo pino 9 Trig pino 10
...
void loop() {
  ...
  String StringUltrassonico1 = "";
  String StringUltrassonico2 = "";
  ...
  StringUltrassonico1 += String(distancia1);
  StringUltrassonico1 += ",";
  
  StringUltrassonico2 += String(distancia2);
  StringUltrassonico2 += ",";
  ...
  StringACE_MPU2 += String(AccX1*9.8/4096);
  StringACE_MPU2 += ",";
  StringACE_MPU2 += String(AccY1*9.8/4096);
  StringACE_MPU2 += ",";
  StringACE_MPU2 += String(AccZ1*9.8/4096);
  StringACE_MPU2 += ",";

  StringGIRO_MPU2 += String(GyrX1/131);
  StringGIRO_MPU2 += ",";
  StringGIRO_MPU2 += String(GyrY1/131);
  StringGIRO_MPU2 += ",";
  StringGIRO_MPU2 += String(GyrZ1/131);
  StringGIRO_MPU2 += ",";
  ...
  if (dataFile) {
    ...
    dataFile.print(StringUltrassonico1);
    dataFile.print(StringUltrassonico2);
